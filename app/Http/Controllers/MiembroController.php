...
class MiembroController extends Controller
{
	...
	public function store(RegistrarMiembrosRequest $request)
	{
		...
		if($miembro)
		{
			Mail::send('emails.bienvenido', ['miembro' => $miembro], function ($m) use ($miembro) {
				$m->from('inscripciones@armorgym.com.mx', 'Armor Gym');
				$m->to($miembro->email,$miembro->nombre.' '.$miembro->apellidos)->subject('Bienvenido a Armor Gym');
			});
